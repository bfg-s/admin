        ...
        if ($this->default_tools !== false) {
            ...
            if ($test('modelInfo') && $isRoot) {
                ...
                $infoRows = $nowMenu ? [
                    ...
                    'Show link' => "<span class='badge badge-success'>GET|HEAD</span> " . $nowMenu->getLinkShow(':id'),
                    'Update link' => "<span class='badge badge-primary'>PUT|PATCH</span> " . $nowMenu->getLinkUpdate(':id'),
                    'Destroy link' => "<span class='badge badge-danger'>DELETE</span> " . $nowMenu->getLinkDestroy(':id'),
                    'Index link' => "<span class='badge badge-success'>GET|HEAD</span> " . $nowMenu->getLinkIndex(),
                    'Create link' => "<span class='badge badge-warning'>POST</span> " . $nowMenu->getLinkStore(),
                    'Update form link' => "<span class='badge badge-success'>GET|HEAD</span> " . $nowMenu->getLinkEdit(':id'),
                    'Create form link' => "<span class='badge badge-success'>GET|HEAD</span> " . $nowMenu->getLinkCreate(),
