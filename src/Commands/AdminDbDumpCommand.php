...
class AdminDbDumpCommand extends Command
{
    /**
     * @var string
     */
    public static $file_name = 'AdminDumpSeeder';
     ...
     * @var string
     */
    protected $signature = 'admin:db_dump';
     ...
     * @var string
     */
    protected $description = 'Make admin db seeds';
    ...
    protected function class_exists(string $class)
    {
        ...
        if ($date) {
            ...
            if (!is_dir(database_path('seeds/AdminDumps'))) {
                mkdir(database_path('seeds/AdminDumps'), 0777, true);
            }

            file_put_contents(
                database_path("seeds/AdminDumps/{$name}.dump"),
