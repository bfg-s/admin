        ...
        <div class="card-header">
            @if($model_id)
                <span>
                    ...
                    @if($created_at) 🔹 <strong>Created at:</strong> {{ beautiful_date_time($created_at) }} @endif
                    @if($updated_at) 🔹 <strong>Updated at:</strong> {{ beautiful_date_time($updated_at) }} @endif
                </span>
            @endif
