    ...
    <div class="px-3 py-3 lg:px-5 lg:pl-3" @updateWithPjax>
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center">
                ...
                <button class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700" data-click="back" title="@lang('admin.back')" href="javascript:void(0)"><i
                        class="fas fa-arrow-left"></i></button>

                <button class="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700" data-click="reload" title="@lang('admin.refresh')" href="javascript:void(0)"><i
