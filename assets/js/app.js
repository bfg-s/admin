...
function (_Executor) {
  ...
  function AdminLte() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(AdminLte).apply(this, arguments));
  }
...
function (_Executor) {
  ...
  _createClass(_class, [{
    ...
    value: function slug() {
      ...
      str = str.toLowerCase().replace(new RegExp('[^a-z0-9' + separator + '\\s]', 'g'), '');
      str = str.replace(new RegExp('[' + separator + '\\s]+', 'g'), separator);
      var result = str.replace(new RegExp('^[' + separator + '\\s]+|[' + separator + '\\s]+$', 'g'), '');
