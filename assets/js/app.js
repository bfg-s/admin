...
module.exports = /*#__PURE__*/function (_Executor) {
  ...
  _createClass(_class, [{
    ...
    value: function slug() {
      ...
      var result = str.toLowerCase().replace(new RegExp('\\s', 'g'), separator).replace(new RegExp('\\s\\s', 'g'), separator).replace(new RegExp('[' + separator + separator + ']+', 'g'), separator).replace(new RegExp('[^a-z0-9' + separator + '\\s]', 'g'), '');
    ...
    value: function __invoke() {
      ...
      if (ids.length && this.jax) {
        var call_jax = function call_jax() {
          get(window.jax, _this.jax)(_this.object, ids);
        };
