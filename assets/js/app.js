...
function (_Executor) {
  ...
  _createClass(_class, [{
    ...
    value: function simple() {
      ...
      var data = this.target.innerHTML;
...
function (_Executor) {
  ...
  _createClass(_class, [{
    ...
    value: function color() {
      ...
      return $(this.target).colorpicker().on('colorpickerChange', function (event) {
        $(_this.target).parents('.input-group').find('.fa-square').css('color', event.color.toString());
      });
    }
  }, {
    key: "icon",
    value: function icon() {
      ...
      return $(this.target).iconpicker({
        ...
        $(_this2.target).parents('.input-group').find('input').val(e.icon);
      });
    }
  }, {
    key: "date",
    ...
    value: function __invoke() {
      ...
      return $(this.target).validate({
        ...
        errorPlacement: function errorPlacement(error, element) {
          var label = $('<div></div>').addClass('col-sm-2'),
              errWrap = $('<div></div>').addClass('col-sm-10').append(error.addClass('invalid-feedback')),
...
var load = function load() {
  __webpack_require__(/*! ./lte_load */ "./javascript/lte_load.js");
};
