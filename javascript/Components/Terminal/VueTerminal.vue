<template>
    <div class="vue-terminal-wrapper">
        <div v-if="this.waiting" class="lds-css">
        ...
        <div id="terminal"
             ...
             v-bind:style="{ maxHeight: this.height }"></div>
    </div>
</template>
...
export default {
    ...
    mounted() {
        const commandEmitter = (cmd_opts, commandText, ...a) => {
            return this.command(cmd_opts, ...a)
        }
